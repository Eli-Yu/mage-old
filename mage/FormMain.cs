    ...
    public partial class FormMain : Form, Editor
    {
        ...
        private void comboBox_clipdata_SelectedIndexChanged(object sender, EventArgs e)
        {
            button_Clip.Image = (comboBox_clipdata.SelectedItem.ToString().Split('-')[0].Trim()) switch
            {
                ...
                "15" => Resources.shortcut_slope27_Uneg,
                "16" => Resources.shortcut_slope27_Lneg,
                "1B" => Resources.shortcut_water,
                "1C" => Resources.shortcut_wet,
                "1D" => Resources.shortcut_dusty,
                "18" => Version.IsMF ? Resources.shortcut_ladder_ceiling : null,
                "19" => Version.IsMF ? Resources.shortcut_ladder_right : null,
                "1A" => Version.IsMF ? Resources.shortcut_ladder_left : null,
                "20" => Resources.shortcut_trans_door,
                "21" => Resources.shorcut_ceiling45_pos,
                "22" => Resources.shorcut_ceiling45_neg,
                "23" => Resources.shorcut_ceiling27_Upos,
                "24" => Resources.shorcut_ceiling27_Lpos,
                "25" => Resources.shorcut_ceiling27_Lneg,
